...
export interface BetTicketInterface extends utils.Interface {
  functions: {
    ...
    "mintTicket(address,uint256,uint256,uint256)": FunctionFragment;
    ...
    "ticketInfo(uint256)": FunctionFragment;
...
export interface BetTicket extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BetTicketInterface;
  ...
  functions: {
    ...
    mintTicket(
      ...
      choiceIndex: PromiseOrValue<BigNumberish>,
